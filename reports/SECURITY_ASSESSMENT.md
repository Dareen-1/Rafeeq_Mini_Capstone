...
- New synthetic case | الحالة الاصطناعية الجديدة: `{"asset": "Order data / بيانات الطلب", "case_id": "L-SEC-001", "control": "التحقق من اللغة قبل التوجيه ورفض الطلبات المختلطة", "expected_flag": "locale_conflict_detected", "payload_length": 33}`
...
- Assessment run ID | معرّف التقييم: `run-3beb087c60d74ef8`
