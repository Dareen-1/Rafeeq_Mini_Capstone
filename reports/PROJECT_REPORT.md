...
- Assessment run ID | معرّف تشغيل التقييم: `run-3beb087c60d74ef8`
- Generated UTC | وقت الإنشاء: 2026-09-22T13:42:48.059331+00:00
...
- Median latency | وسيط الزمن: 1.221 ms
...
- New threat case metadata | بيانات الحالة الجديدة: `{"asset": "Order data / بيانات الطلب", "case_id": "L-SEC-001", "control": "التحقق من اللغة قبل التوجيه ورفض الطلبات المختلطة", "expected_flag": "locale_conflict_detected", "payload_length": 33}`
...
- Before | قبل: 3.229 ms / 500 iterations
- After | بعد: 0.556 ms / 500 iterations
- Cache hits / misses | إصابات / إخفاقات التخزين: 499 / 1
- Learner trade-off and guardrail | مقايضة وضابط المتدرب: trade_off: الكاش قد يحتفظ بسياسة قديمة إذا تغير الإصدار — قبل الكاش: 3.229ms بعد الكاش: 0.556ms | guardrail: مفتاح الكاش يحتوي رقم الإصدار active_policy_version=2026.1 حتى يتجدد تلقائياً عند أي تغيير — cache_hits=499
